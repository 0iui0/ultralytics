...
class MultiTaskTrainer(yolo.detect.DetectionTrainer):
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        """Initialize a MultiTaskTrainer object with specified configurations and overrides."""
    ...
    def get_model(self, cfg=None, weights=None, verbose=True):
        """Get multi-task model with specified configuration and weights."""
    ...
    def get_validator(self):
        """Returns an instance of the MultiTaskValidator class for validation."""
