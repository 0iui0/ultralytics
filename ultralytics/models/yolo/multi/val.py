...
class MultiTaskValidator(DetectionValidator):
    ...
    Example:
        ```python
        from ultralytics.models.yolo.multi import MultiTaskValidator

        args = dict(model='yolov8n-multi.pt', data='coco8-multi.yaml')
    ...
    def __init__(self, dataloader=None, save_dir=None, pbar=None, args=None, _callbacks=None):
        """Initialize a 'MultiTaskValidator' object with custom parameters and assigned attributes."""
